...
ja: {
  ...
  home: {
    ...
    h2:{ title:"地元と築いた安全体制", body:"通常、流氷上での活動には地元の特別な許可とガイドの同行が必要です。私たちは11年かけて地元漁業関係者・消防・医療機関との信頼関係を築き、セーフティダイバー、スキューバサポート、医師常駐という体制で安全に運営しています。" },
  ...
  about: {
    ...
    safety3:{ title:"医師の帯同", body:"現場には医師が常駐し、低体温症など寒冷環境特有のリスクに備えます。" },
...
en: {
  ...
  home: {
    ...
    h2:{ title:"A safety system built with the local community", body:"Activity on drift ice normally requires special local permission and a licensed guide. Over 11 years we've built trust with local fishing cooperatives, fire services and medical staff, and we operate with safety divers, scuba support and an on-site doctor." },
  ...
  about: {
    ...
    safety3:{ title:"An on-site doctor", body:"A doctor is present on site at all times, ready for hypothermia and other risks specific to a cold-water environment." },
    ...
    safety6:{ title:"A track record with world-record attempts", body:"We've organized a world-record attempt to full CMAS international standards, and maintain working relationships with internationally certified judges." },
...
zh: {
  ...
  home: {
    ...
    h2:{ title:"與當地共同建立的安全體制", body:"通常在流冰上活動需要當地特別許可與嚮導陪同。我們花費11年與當地漁業相關人士、消防及醫療機構建立信賴關係，配置安全潛水員、水肺支援團隊及駐地醫師，以確保安全運作。" },
  ...
  about: {
    ...
    safety3:{ title:"醫師隨行", body:"現場全程有醫師駐守，以應對失溫症等寒冷環境特有的風險。" },
    ...
    safety6:{ title:"世界紀錄挑戰的實績", body:"我們具備依循CMAS國際標準舉辦世界紀錄挑戰的實績，並與國際認證裁判建立合作體制。" },
...
ko: {
  ...
  home: {
    ...
    h2:{ title:"지역과 함께 쌓아온 안전 체계", body:"일반적으로 유빙 위 활동에는 현지의 특별 허가와 가이드 동행이 필요합니다. 저희는 11년에 걸쳐 지역 어업 관계자, 소방, 의료기관과 신뢰 관계를 쌓았으며, 안전 다이버, 스쿠버 지원팀, 상주 의사 체계로 안전하게 운영하고 있습니다." },
  ...
  about: {
    ...
    safety3:{ title:"의사 동행", body:"현장에는 의사가 상주하여 저체온증 등 한랭 환경 특유의 위험에 대비합니다." },

...
ja: {
  ...
  home: {
    ...
    h2:{ title:"地元と築いた安全体制", body:"通常、流氷上での活動には地元の特別な許可とガイドの同行が必要です。私たちは11年かけて地元漁業関係者・消防・医療機関との信頼関係を築き、セーフティダイバー、スキューバサポートという体制で安全に運営しています。" },
  ...
  about: {
    ...
    history:{ eyebrow:"HISTORY", title:"11年以上の歩み" },
    ...
    safety:{ eyebrow:"SAFETY FIRST", title:"安全への取り組み", lead:"氷点下の海での活動は、通常のフリーダイビングとは異なるリスクを伴います。私たちは11年間の運営で培った体制のもと、安全を最優先に活動しています。", disclaimer:"※氷点下でのフリーダイビングは大変危険を伴います。本イベントは地元の特別な許可と専門チームの安全管理のもとで実施しているものであり、個人で流氷下に潜ることは絶対にお控えください。" },
...
en: {
  meta: {
    ...
    about: { title:"About Shiretoko & Drift Ice Freediving | Ice Freediving Shiretoko", desc:"What Shiretoko is, what drift ice freediving is, our 11-year history and our safety system." },
  ...
  home: {
    ...
    h2:{ title:"A safety system built with the local community", body:"Activity on drift ice normally requires special local permission and a licensed guide. Over 11 years we've built trust with local fishing cooperatives, fire services and medical staff, and we operate with safety divers and scuba support." },
...
zh: {
  meta: {
    ...
    about: { title:"關於知床與流冰自由潛水 | Ice Freediving Shiretoko", desc:"認識知床、流冰自由潛水是什麼、11年來的歷史與安全體制。" },
  ...
  home: {
    ...
    h2:{ title:"與當地共同建立的安全體制", body:"通常在流冰上活動需要當地特別許可與嚮導陪同。我們花費11年與當地漁業相關人士、消防及醫療機構建立信賴關係，配置安全潛水員、水肺支援團隊，以確保安全運作。" },
  ...
  about: {
    ...
    history:{ eyebrow:"歷史", title:"超過11年的歷程" },
    ...
    safety:{ eyebrow:"安全第一", title:"我們對安全的堅持", lead:"在零下低溫的海域中活動，伴隨著與一般自由潛水不同的風險。我們憑藉11年營運所累積的體制，將安全放在活動的最優先位置。", disclaimer:"在零下低溫中進行自由潛水伴隨極大危險。本活動僅在當地特別許可及專業團隊的安全管理下進行，請絕對不要嘗試個人潛入流冰之下。" },
...
ko: {
  ...
  home: {
    ...
    h2:{ title:"지역과 함께 쌓아온 안전 체계", body:"일반적으로 유빙 위 활동에는 현지의 특별 허가와 가이드 동행이 필요합니다. 저희는 11년에 걸쳐 지역 어업 관계자, 소방, 의료기관과 신뢰 관계를 쌓았으며, 안전 다이버, 스쿠버 지원팀 체계로 안전하게 운영하고 있습니다." },
  ...
  about: {
    ...
    history:{ eyebrow:"HISTORY", title:"11년 이상의 발자취" },
    ...
    safety:{ eyebrow:"SAFETY FIRST", title:"안전을 위한 노력", lead:"영하의 바다에서의 활동은 일반적인 프리다이빙과는 다른 위험을 수반합니다. 저희는 11년간의 운영을 통해 다져온 체계를 바탕으로 안전을 최우선으로 활동하고 있습니다.", disclaimer:"※영하의 환경에서 이루어지는 프리다이빙은 매우 위험합니다. 본 행사는 현지의 특별 허가와 전문 팀의 안전 관리 아래 진행되는 것으로, 개인이 유빙 아래로 잠수하는 것은 절대 삼가시기 바랍니다." },
